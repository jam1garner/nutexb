pub fn deswizzle(width: u32, height: u32, _depth: u32, blk_width: u32, blk_height: u32, _blk_depth: u32, round_pitch: bool, bpp: u32, tile_mode: u32, size_range: i32, data: &[u8]) -> Vec<u8> {
    _swizzle(width, height, _depth, blk_width, blk_height, _blk_depth, round_pitch, bpp, tile_mode, size_range, data, false)
}

pub fn swizzle(width: u32, height: u32, _depth: u32, blk_width: u32, blk_height: u32, _blk_depth: u32, round_pitch: bool, bpp: u32, tile_mode: u32, size_range: i32, data: &[u8]) -> Vec<u8> {
    _swizzle(width, height, _depth, blk_width, blk_height, _blk_depth, round_pitch, bpp, tile_mode, size_range, data, true)
}
...
fn _swizzle(width: u32, height: u32, _depth: u32, blk_width: u32, blk_height: u32, _blk_depth: u32, round_pitch: bool, bpp: u32, tile_mode: u32, block_height_log_2: i32, data: &[u8], to_swizzle: bool) -> Vec<u8> {
...
fn get_addr_block_linear(x: u32, y: u32, width: u32, bytes_per_pixel: u32, base_address: u32, block_height: u32) -> u32 {
    /*
      From Tega X1 TRM 
                       */
    ...
    gob_address + ((x % 64) / 32) * 256 + ((y % 8) / 2) * 64
